...
@Service
public class GrupoDeEstudoService {
    private GrupoDeEstudoRepository grupoRepository;
    private AreaEstudoRepository areaRepository;
    private UsuarioRepository usuarioRepository;

    @Autowired
    public GrupoDeEstudoService(GrupoDeEstudoRepository grupoRepository, AreaEstudoRepository areaRepository, UsuarioRepository usuarioRepository) {
...
//                .orElseThrow(() -> new RuntimeException("Usuário criador não encontrado"));
        ...
        grupo.setUsuarios(Set.of(criador));
